export declare const DatesStyled: import("@stitches/react/types/styled-component").StyledComponent<"div", {}, {}, import("@stitches/react/types/css-util").CSS<{}, {
    colors: {
        accent: string;
        background: string;
        inverted: string;
...
export default DatesStyled;
//# sourceMappingURL=Dates.styles.d.ts.map