...
export declare const InputCoreStyled: import("@stitches/react/types/styled-component").StyledComponent<"div", import("@stitches/react/types/styled-component").StyledComponentProps<[{
    '&:focus-within': {
        boxShadow: string;
    };
    '&:hover': {
...
export declare const InputCallbackStyled: import("@stitches/react/types/styled-component").StyledComponent<"div", {}, {}, import("@stitches/react/types/css-util").CSS<{}, {
    colors: {
        accent: string;
        background: string;
        blueBorder: string;
