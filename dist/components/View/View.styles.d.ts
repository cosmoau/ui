...
export declare const ViewContainerStyled: import("@stitches/react/types/styled-component").StyledComponent<"div", import("@stitches/react/types/styled-component").StyledComponentProps<[{
    position: string;
    variants: {
        container: {
            false: {
