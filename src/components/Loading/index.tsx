      ...
      <g fill="none" fillRule="evenodd">
        <g strokeWidth="2" transform="translate(1 1)">
          ...
          <path d="M36 18c0-9.94-8.06-18-18-18">
            <animateTransform attributeName="transform" dur=".55s" from="0 18 18" repeatCount="indefinite" to="360 18 18" type="rotate" />
          </path>
        </g>
      </g>
    </svg>
...
export function LoadingOverlay({ vertical = "bottom", horizontal = "right", width }: LoadingProps): JSX.Element {
  return (
