  ...
  return (
    <LogoStyled
      ...
      <svg height={height} viewBox="0 0 463.7 141.4" width={width} {...rest}>
        ...
        <path d="m44.4 96.3c-7.5-10.3-13.3-22.9-16.1-35.8-7.3 6.4-14.7 16.2-18.4 27.2 7.2 5.7 21 7.9 34.5 8.6z" fill="#583749" />
        <path
        ...
        <path
          ...
          fill="#295f9c"
        />
        <path d="m61.3 34.1c19.5 12.5 23.2 15.9 32.6 26 .3.4.7.7 1 1.1 3.2-11 5.5-23.2 4.9-34-13.8-3.2-28.7.2-38.5 6.9z" fill="#ae282e" />
        <path
