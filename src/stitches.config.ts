...
export const { theme, css, styled, getCssText } = createStitches({
  theme: {
    colors: {
      ...
      baseContrast200: 'rgb(242, 248, 255)',
      ...
      navy300: 'rgba(0, 76, 104, 0.06)',
      navy400: 'rgba(0, 76, 104, 0.03)',
      ...
      border100: 'rgba(0, 1, 2, 0.12)',
      border200: 'rgba(0, 1, 2, 0.08)',
      border300: 'rgba(0, 1, 2, 0.06)',
    },
    space: {
      1: '0.2rem',
      2: '0.4rem',
...
export const darkTheme = createTheme('dark', {
  colors: {
    ...
    blue400: 'rgba(5, 91, 141, 0.2)',
    navy100: 'inherit',
    navy200: 'rgba(255,255,255, 0.2)',
    navy300: 'rgba(255,255,255, 0.08)',
    navy400: 'rgba(255,255,255, 0.06)',
    purple100: 'rgb(89, 33, 141)',
    purple200: 'rgb(219, 195, 244)',
    purple300: 'rgb(229, 212, 246)',
    purple400: 'rgba(89, 33, 141, 0.2)',
