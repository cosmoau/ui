...
export const { theme, css, styled, getCssText, globalCss, keyframes } = createStitches({
  theme: {
    colors: {
      ...
      metricGreenA: "rgb(22, 100, 115)",
      metricGreenB: "rgb(71, 181, 115)",
      metricOrangeA: "rgb(157, 63, 34)",
      metricOrangeB: "rgb(223, 137, 112)",
      metricPurpleA: "rgb(74, 75, 169)",
      metricPurpleB: "rgb(165, 170, 244)",
      metricRedA: "rgb(160, 8, 8)",
      metricRedB: "rgb(223, 88, 93)",
      metricYellowA: "rgb(161, 126, 12)",
      metricYellowB: "rgb(233, 186, 46)",
