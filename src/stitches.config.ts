...
export const { theme, css, styled, getCssText, globalCss, keyframes } = createStitches({
  theme: {
    colors: {
      ...
      // metric
      metricBlueA: "rgb(43, 94, 144)",
      metricBlueB: "rgb(148, 195, 243)",
      metricGreenA: "rgb(39, 118, 134)",
      metricGreenB: "rgb(151, 226, 191)",
      metricOrangeA: "rgb(210, 82, 43)",
      metricOrangeB: "rgb(248, 178, 156)",
      metricPurpleA: "rgb(74, 75, 169)",
      metricPurpleB: "rgb(165, 170, 244)",
      metricRedA: "rgb(224, 70, 77)",
      metricRedB: "rgb(252, 157, 160)",
      metricYellowA: "rgb(201, 147, 38)",
      metricYellowB: "rgb(239, 184, 107)",
      // metric
