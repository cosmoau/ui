...
export const lightTheme = createTheme({
  colors: {
    ...
    border: "rgba(10, 15, 42, 0.16)",
    default: "rgba(10, 15, 42, 0.04)",
    defaultHover: "rgba(10, 15, 42, 0.08)",
    greenText: "rgb(0, 76, 6)",
    orangeText: "rgb(199, 84, 30)",
    pinkText: "rgb(173, 22, 128)",
    purpleText: "rgb(112, 23, 171)",
    redText: "rgb(170, 28, 47)",
    soft: "rgba(10, 15, 42, 0.035)",
    text: "rgb(10, 32, 52)",
  },
  shadows: {
    a: "0 0.3rem 0.4rem 0 rgba(10, 15, 42, 0.06)",
    b: "0 0.6rem 0.6rem 0 rgba(10, 15, 42, 0.09)",
    c: "0 0.6rem 0.9rem 0 rgba(10, 15, 42, 0.12)",
  },
});
