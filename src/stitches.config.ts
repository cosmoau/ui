...
export const { theme, css, styled, getCssText, globalCss, keyframes } = createStitches({
  theme: {
    colors: {
      ...
      default: "rgba(51, 31, 31, 0.05)",
      defaultHover: "rgba(51, 31, 31, 0.1)",
    ...
    shadows: {
      large: "0 0.4rem 0.8rem 0 rgba(8, 12, 36, 0.2)",
      small: "0 0.2rem 0.4rem 0 rgba(8, 12, 36, 0.15)",
    },
    space: {
      excess: "12rem",
      large: "4rem",
...
export const darkTheme = createTheme({
  colors: {
    ...
    default: "rgba(200, 220, 240, 0.25)",
    defaultHover: "rgba(200, 220, 240, 0.5)",
